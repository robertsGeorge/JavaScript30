...
* Use of conditional recursive call of randomHole function, to stop the problem of it outputting the same result in a row (which if there are 6 possibilities, there is a 1/6 chance of).